<?php
	include_once("hand_admin.php");
	$sql = "select * from a_1_3_title_pic where  a_1_3_t_p_seq = '".$_GET["pic"]."'";
...
<div style="width:100%; height:87%; margin:auto; overflow:auto;">
	...
	<form method="post" enctype="multipart/form-data">
		<table width="100%">		
				<tr>
					<td width="45%" align="right">標題區圖片：</td>
					<td width="55%" align="left">
						<input name="update_pic" type="file">
						<input name="update_pic_no" type="hidden" value = "<?=$_GET["pic"]?>">
						<input name="update_pic_name" type="hidden" value = "<?=$oo["a_1_3_t_p_title"]?>">
					</td>				
				</tr>
